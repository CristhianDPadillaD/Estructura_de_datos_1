...
public class Discotienda
{
 ...
 // -----------------------------------------------------------------
    // Trabajo Estructura de datos 1
    // -----------------------------------------------------------------
/**
 * Generar el informe de los discos de rock y pop que no superre los mil pesos
 * @trhows FileNotFoundException - Cuando no encuentra el archivo
 */
    public void generarInformeDiscosRPMenores () throws FileNotFoundException {
    	File archivo = new File ("./data/discosCostosos.txt"); 
    	
    	PrintWriter pluma = new PrintWriter(archivo);
    	
    	pluma.println("Reporte de discos de genero Rock y Pop que no superen mil pesos");
    	pluma.println("=================");
    ...
    {
    	try {
    		generarInformeDiscosRPMenores ();
    		return "Se generó el reporte correctamente";
    	}catch(Exception e) {
